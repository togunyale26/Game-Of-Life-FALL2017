...
function checkCells(){
    for( var i = 0; i < rows; i++){
        for( var j = 0; j < cols; j++){
            ...
            // 0, last val
            else if(currentCellR == 0 && (currentCellC == cols)){
                // 0, lastval -1
                if(VirtualArr[currentCellR][currentCellC - 1] == 1){
                    count+=1;
                }
            ...
            // lastval, 0
            else if(currentCellR == rows && (currentCellC == 0)){
            ...
            // lastval, lastval
            else if(currentCellR == rows && (currentCellC == cols)){
                // lastval - 1 , lastval - 1
                if(VirtualArr[currentCellR - 1][currentCellC - 1] == 1){
                    count+=1;
                }
            ...
            // Left hand Edges
            else if((currentCellR > 0 && currentCellR < rows ) && (currentCellC == 0)){
            ...
            // Right Hand Edges
            else if ((currentCellR > 0 && currentCellR < rows ) && (currentCellC == cols)){
            ...
            // Top Edges
            else if((currentCellC > 0 && currentCellC < cols ) && (currentCellR == 0)){
            ...
            else if((currentCellC> 0 && currentCellC < cols ) && (currentCellC == rows)){
